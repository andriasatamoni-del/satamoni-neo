...
export const ReceiptIcon = (p: SVGProps<SVGSVGElement>) => (
  <Icon {...p}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3.75h10.5a.75.75 0 01.75.75v15.19a.375.375 0 01-.57.32l-1.68-1.03-1.68 1.03a.75.75 0 01-.78 0l-1.79-1.03-1.79 1.03a.75.75 0 01-.78 0l-1.68-1.03-1.68 1.03a.375.375 0 01-.57-.32V4.5a.75.75 0 01.75-.75z" />
